...
$(document).ready(function() {
    ...
    $(".index .post-outer,.archive .post-outer").each(function() {
        $(this).find(".block-image .thumb a").attr("style", function(a, b) {
            ...
            return b.replace("s72-c", "s640")
        })
    });
    $(".index .post-outer,.archive .post-outer").each(function() {
        $(this).find(".block-image .thumb a").attr("style", function(a, b) {
            return b.replace("https://3.bp.blogspot.com/-Yw8BIuvwoSQ/VsjkCIMoltI/AAAAAAAAC4c/s55PW6xEKn0/s640-r/nth.png", "" + NO_IMAGE + "")
        })
    });
        ...
        success: function(e) {
            ...
            for (var i = 0; i < e.feed.entry.length; i++) {
                ...
                if (yk.match('//img1.blogblog.com/img/blank.gif')) {
                    var k = '//4.bp.blogspot.com/-uCjYgVFIh70/VuOLn-mL7PI/AAAAAAAADUs/Kcu9wJbv790hIo83rI_s7lLW3zkLY01EA/s55-r/avatar.png'
                } else {
                ...
                success: function(e) {
                    ...
                    for (var i = 0; i < e.feed.entry.length; i++) {
                        ...
                        if (c.indexOf("//www.youtube.com/embed/") > -1) {
                            ...
                            var q = $c.find('img:first').attr('src').replace('s72-c', 's640');
                            var k = q
                        } else {
                            var k = NO_IMAGE
                        }
